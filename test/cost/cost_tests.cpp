...
TEST(sample_test_case123, sample_test123)
{
  ...
  trafic_measurements.push_back(Measurement(   6, 1305.42 , 1190.093, 14.79066,-0.7870631, 529.9634, 2.023912));
  trafic_measurements.push_back(Measurement(   7, 1410.518, 1175.312, 17.96696, -2.225884, 636.3141, 5.874688));
  trafic_measurements.push_back(Measurement(   8, 1337.232, 1186.813, 14.80411, -1.951285, 562.0803, 1.845128));
